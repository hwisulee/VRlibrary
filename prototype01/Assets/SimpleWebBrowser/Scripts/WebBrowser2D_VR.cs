...
{
    public class WebBrowser2D_VR : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler,
        IPointerUpHandler
    {
        #region General
        ...
        private static WebBrowser2D_VR m_instance = null;
        private static WebBrowser2D_VR Instance
        {
            get
            {
                if (!m_instance)
                {
                    m_instance = Instantiate(Resources.Load<GameObject>("SimpleWebBrowserCanvas")).GetComponent<WebBrowser2D_VR>();
 ...
 public void RunJavaScript(string js)
        ...
        {
            var mousepos = OVRRaycaster.ScreenPos;
